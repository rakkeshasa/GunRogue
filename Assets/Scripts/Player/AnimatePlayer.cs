...
public class AnimatePlayer : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        player.movementToPositionEvent.OnMovementToPosition += MovementByPositionEvent_OnMovementToPosition;
    ...
    private void MovementByPositionEvent_OnMovementToPosition(MovementToPositionEvent movementToPositionEvent, MovementToPositionArgs movementToPositionArgs)
    {
    ...
    private void IdleEvent_OnIdle(IdleEvent idelEvent)
    {
        InitializeRollAnimationParameters();
